...
export class GpuUniformBatchPipe
{
    ...
    #_bindGroupHash: Record<number, BindGroup> = Object.create(null);
    readonly #_batchBuffer: UboBatch;

    // number of buffers..
    #_buffers: Buffer[] = [];

    #_bindGroups: BindGroup[] = [];
    #_bufferResources: BufferResource[] = [];
    ...
    #_getBufferResource(index: number): BufferResource
    {
    ...
    #_getBindGroup(index: number): BindGroup
    {
