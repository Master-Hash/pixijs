...
export class GlTextureSystem implements System, CanvasGenerator
{
    ...
    #_glTextures: Record<number, GlTexture> = Object.create(null);
    #_glSamplers: Record<string, WebGLSampler> = Object.create(null);

    #_boundTextures: TextureSource[] = [];
    #_activeTextureLocation = -1;

    #_boundSamplers: Record<number, WebGLSampler> = Object.create(null);

    readonly #_uploads: Record<string, GLTextureUploader> = {
    ...
    #_mapFormatToInternalFormat: Record<string, number>;
    #_mapFormatToType: Record<string, number>;
    #_mapFormatToFormat: Record<string, number>;

    #_premultiplyAlpha = false;

    // TODO - separate samplers will be a cool thing to add, but not right now!
    readonly #_useSeparateSamplers = false;
    ...
    #_bindSampler(style: TextureStyle, location = 0): void
    {
        const gl = this.#_gl;
    ...
    #_initSource(source: TextureSource): GlTexture
    {
        const gl = this.#_gl;
    ...
    #_initSampler(style: TextureStyle): WebGLSampler
    {
        const gl = this.#_gl;
    ...
    #_getGlSampler(sampler: TextureStyle): WebGLSampler
    {
